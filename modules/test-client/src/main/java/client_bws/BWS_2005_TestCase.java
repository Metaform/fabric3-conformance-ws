 ...
 */
public class BWS_2005_TestCase { // extends BaseJAXWSTestRunner {
...
//    	config.contributionNames = new String[] { "BWS_2005", "BWS_General", "BWS_General" + _Lang };
//    	config.serviceInterface  = TestInvocation.class;
//    	return config;
//    }
    
} // end class Test_BWS_2005
