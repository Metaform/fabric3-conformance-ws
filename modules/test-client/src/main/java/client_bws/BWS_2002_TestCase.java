...
/**
 * Client for BWS_2002_TestCase
 * Tests that a binding.ws/@wsdlElement attribute value points to an existing WSDL 1.1 element
 * 
 * This testcase is designed to fail
 */
public class BWS_2002_TestCase { //{ // extends BaseJAXWSTestRunner {
...
//    	config.contributionNames = new String[] { "BWS_2002", "BWS_General" + _Lang };
//    	config.serviceInterface  = TestInvocation.class;
//    	return config;
//    }
    
} // end class Test_BWS_2002
